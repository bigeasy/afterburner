...
function prove (okay) {
    ...
    var source = fs.readFileSync(path.join(__dirname, 'parse/arguments.in.js'), 'utf8')
    var actual = strip(parser.walk(source))
    var expected = strip(acorn.parse(fs.readFileSync(path.join(__dirname, 'parse/arguments.out.js'), 'utf8')))
